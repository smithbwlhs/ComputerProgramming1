...
def my_solution(favorite_integer, favorite_character):
    ...
    if favorite_integer >= 0:
        ...
        print("\t" + str(favorite_integer) + " is a negative number,")
    ...
    match favorite_integer:
        case 2:
            print("\tand it is the atomic number of Helium.")
        case 10:
            print("\tand it is the atomic number of Neon.")
        case 18:
            print("\tand it is the atomic number of Argon.")
        case 36:
            print("\tand it is the atomic number of Krypton.")
        case 54:
            print("\tand it is the atomic number of Xenon.")
        case 86:
            print("\tand it is the atomic number of Radon.")
        case 118:
            print("\tand it is the atomic number of Oganesson.")
        case _:
    ...
    if favorite_character.isdigit():
        ...
        print("\t"+favorite_character+" is not a letter or number,")

    if favorite_character.isupper() or favorite_character.islower():
